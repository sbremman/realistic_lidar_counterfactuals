...
def get_icinco_model():
    policy_model = load_model('models_and_data/icinco_model/ICINCO_model.zip')

    return policy_model

def get_best_val_model():
    policy_model = load_model('models_and_data/best_val_trained_gazebo/model.zip')
...
if __name__ == '__main__':
    policy_model = get_best_val_model()
    ...
    #icinco_actions = icinco_model(tensor_states)
    test_actions = policy_model(tensor_states)
